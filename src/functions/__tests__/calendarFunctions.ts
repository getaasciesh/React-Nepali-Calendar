...
describe('Calendar functions', () => {
  ...
  it('should correctly convert ad date to bs date', () => {
    expect(calendarFunctions.convertADtoBS(2018, 7, 7)).
      toEqual({ "bsDate": 23, "bsMonth": 3, "bsYear": 2075 });
    expect(calendarFunctions.convertADtoBS(2018, 8, 18)).
      toEqual({ "bsDate": 2, "bsMonth": 5, "bsYear": 2075 });
    expect(calendarFunctions.convertADtoBS(2018, 9, 10)).
      toEqual({ "bsDate": 25, "bsMonth": 5, "bsYear": 2075 });
    expect(calendarFunctions.convertADtoBS(2018, 12, 30)).
      toEqual({ "bsDate": 15, "bsMonth": 9, "bsYear": 2075 });
    expect(calendarFunctions.convertADtoBS(2019, 1, 1)).
      toEqual({ "bsDate": 17, "bsMonth": 9, "bsYear": 2075 });
    expect(calendarFunctions.convertADtoBS(2019, 6, 23)).
      toEqual({ "bsDate": 8, "bsMonth": 3, "bsYear": 2076 });
    expect(calendarFunctions.convertADtoBS(2025, 9, 11)).
      toEqual({ "bsDate": 26, "bsMonth": 5, "bsYear": 2082 });
    expect(calendarFunctions.convertADtoBS(2028, 3, 13)).
      toEqual({ "bsDate": 30, "bsMonth": 11, "bsYear": 2084 });
    expect(calendarFunctions.convertADtoBS(2017, 4, 13)).
      toEqual({ "bsDate": 31, "bsMonth": 12, "bsYear": 2073 });
  });

  it('should correctly convert bs date to ad date', () => {
    expect(calendarFunctions.convertBStoAD(2076, 3, 8)).
      toEqual(new Date(2019, 5, 23));
    expect(calendarFunctions.convertBStoAD(2075, 4, 1)).
      toEqual(new Date(2018, 6, 17));
    expect(calendarFunctions.convertBStoAD(2075, 5, 7)).
      toEqual(new Date(2018, 7, 23));
    expect(calendarFunctions.convertBStoAD(2075, 7, 19)).
      toEqual(new Date(2018, 10, 5));
    expect(calendarFunctions.convertBStoAD(2075, 11, 1)).
      toEqual(new Date(2019, 1, 13));
    expect(calendarFunctions.convertBStoAD(2076, 1, 23)).
      toEqual(new Date(2019, 4, 6));
    expect(calendarFunctions.convertBStoAD(2076, 2, 29)).
      toEqual(new Date(2019, 5, 12));
    expect(calendarFunctions.convertBStoAD(2083, 6, 16)).
      toEqual(new Date(2026, 9, 2));
    expect(calendarFunctions.convertBStoAD(2087, 8, 18)).
      toEqual(new Date(2030, 11, 4));
    expect(calendarFunctions.convertBStoAD(2073, 12, 31)).
